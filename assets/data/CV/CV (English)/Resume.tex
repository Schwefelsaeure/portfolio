...
\highlightbar{
    ...
    \begin{infolist}
        ...
        \ads{Publications}{https://orcid.org/0000-0003-2344-8265}
    \end{infolist}
...
\mainbar{
    ...
    {\begin{itemize}
    		\item Development of an application including GUI to control SPICE simulators.
    		\item Automated verification of simulation results against specification.
